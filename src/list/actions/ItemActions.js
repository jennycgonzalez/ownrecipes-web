...
export const load = listId => dispatch => {
  request()
 ...
 */
export const add = (title, listLength, listId) => dispatch => {
  request()
...
export const save = (id, title, listId) => dispatch => {
  request()
...
export const toggle = (id, completed, listId) => dispatch => {
  request()
    .patch(`${serverURLs.list_item + id}/`)
...
const ids = items.reduce((list, item) => {
...
export const destroy = (id, listId) => dispatch => {
  request()
