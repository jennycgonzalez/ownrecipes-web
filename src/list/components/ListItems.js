...
export default class ListItems extends Component {
  ...
  render() {
    ...
    const shownItems = items.filter(function (item) {
    ...
    const activeListCount = items.reduce((accum, item) => (item.completed ? accum : accum + 1), 0);

    const completedCount = items.length - activeListCount;
